...
class BDD100k:
    ...
    def populate_train(self):
        ...
        if self.task == 'weather':
            train_csv = pd.read_csv(os.path.join(self.location, 'labels/det_20', 'bdd100k_train_train_labels_v2.csv'), index_col=0)
        elif self.task == 'scene':
            train_csv = pd.read_csv(os.path.join(self.location, 'labels/det_20', 'bdd100k_train_train_labels_v3.csv'), index_col=0)
        ...
        if self.task == 'weather':
            try:
                train_target = pd.read_csv(os.path.join(self.location, 'labels/det_20', f'bdd100k_train_{target_class}_labels_v2.csv'), index_col=0)
            ...
            train_target = pd.read_csv(os.path.join(self.location, 'labels/det_20', f'bdd100k_train_{target_class}_labels_v3.csv'), index_col=0)
    ...
    def populate_test(self, test_flag):
        offset = int(self.task=='scene')
        if test_flag:
            test_csv = pd.read_csv(os.path.join(self.location, 'labels/det_20', f'bdd100k_val_labels_v{2+offset}.csv'), index_col=0)
        else:
            #### validation
            test_csv = pd.read_csv(os.path.join(self.location, 'labels/det_20', f'bdd100k_train_val_labels_v{2+offset}.csv'), index_col=0)
