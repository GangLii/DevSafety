...
do
  ...
  do 
    ...
    CUDA_VISIBLE_DEVICES=0,1 python src/main.py  \
        --train-data="./datasets/data/csvs/tunnel/integrated_laion_bddtunnel_cons1k_neg10t.csv" \
        ...
        --exp_name=bdd100k_overcast/sogpnl_subsetD1k_cln_bddV3_E40B600lr6beta${beta}tau0005t005
  done    
done